...
internal class SingleScheduleEntry : ScheduleEntry {
    ...
    internal override fun getScheduleData() = CreateTaskLoader.ScheduleData.SingleScheduleData(mDate, mTimePair)
    ...
    internal override fun getScheduleType() = ScheduleType.SINGLE
