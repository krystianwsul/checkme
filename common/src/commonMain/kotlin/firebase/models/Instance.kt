...
class Instance private constructor(val task: Task, private var data: Data) : Assignable {
    ...
    fun getTaskHierarchyParentInstance(): Instance? {
        ...
        val interval = task.intervalInfo
            .intervals
            .reversed()
            .asSequence()
        ...
        return when (val type = interval.type) {
            ...
            is Type.NoSchedule -> {
                if (type.noScheduleOrParent != null)
                    ErrorLogger.instance.logException(ParentInstanceException("unexpected interval type. child instance: $this, interval $interval, all intervals: ${task.intervalInfo.intervals}"))
