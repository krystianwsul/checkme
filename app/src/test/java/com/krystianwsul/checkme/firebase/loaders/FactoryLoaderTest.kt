...
class FactoryLoaderTest {
    ...
    @Test
    fun testInitialize() {
        val local = object : FactoryProvider.Local {
        ...
        class TestDomain : FactoryProvider.Domain {
        ...
        class TestDatabase : FactoryProvider.Database() {
        ...
        class TestPreferences : FactoryProvider.Preferences {

            override var tab = 0
        }

        val factoryProvider = object : FactoryProvider {
        ...
        val factoryLoader = FactoryLoader(local, deviceInfoObservable, factoryProvider)
