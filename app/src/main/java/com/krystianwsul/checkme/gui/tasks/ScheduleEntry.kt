...
abstract class ScheduleEntry(var error: String?) : Parcelable {
    ...
    abstract val scheduleData: CreateTaskLoader.ScheduleData

    abstract val scheduleType: ScheduleType

    constructor() : this(null)

    abstract fun getText(customTimeDatas: Map<CustomTimeKey, CreateTaskLoader.CustomTimeData>, context: Context): String
