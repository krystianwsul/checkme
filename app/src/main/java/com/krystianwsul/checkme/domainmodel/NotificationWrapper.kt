...
abstract class NotificationWrapper {
    ...
    private class NotificationWrapperImpl : NotificationWrapper() {
        ...
        override fun notifyInstance(context: Context, domainFactory: DomainFactory, instance: Instance, silent: Boolean, now: ExactTimeStamp, nougat: Boolean) {
            ...
            val actions = ArrayList<android.support.v4.app.NotificationCompat.Action>()
            ...
            actions.add(android.support.v4.app.NotificationCompat.Action.Builder(R.drawable.ic_done_white_24dp, context.getString(R.string.done), pendingDoneIntent).build())
