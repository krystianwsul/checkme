...
class RemoteDailyScheduleBridge(private val kotlinDomainFactory: KotlinDomainFactory, private val mRemoteDailyScheduleRecord: RemoteDailyScheduleRecord) : WeeklyScheduleBridge {
    ...
    override val customTimeKey get() = mRemoteDailyScheduleRecord.customTimeId?.let { kotlinDomainFactory.getCustomTimeKey(mRemoteDailyScheduleRecord.projectId, it) }
