...
abstract class ProjectRecord<T : ProjectType>(
        ...
        committerKey: String,
) : RemoteRecord(create), JsonTime.ProjectIdProvider<T>, JsonTime.ProjectCustomTimeKeyProvider<T> {
    ...
    abstract fun getCustomTimeKey(customTimeId: CustomTimeId.Project<T>): CustomTimeKey.Project<T> // todo customtime project
