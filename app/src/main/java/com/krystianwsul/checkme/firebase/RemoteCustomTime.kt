...
class RemoteCustomTime(private val domainFactory: DomainFactory, private val remoteProject: RemoteProject, val remoteCustomTimeRecord: RemoteCustomTimeRecord) : CustomTime {
