...
import com.krystianwsul.checkme.viewmodels.SearchInstancesEditViewModel
...
fun DomainFactory.getSearchInstancesEditData(
        searchCriteria: SearchCriteria,
        page: Int,
): DomainResult<SearchInstancesEditViewModel.Data> = syncOnDomain {
    ...
    LockerManager.setLocker { now ->
        getDomainResultInterrupting {
            ...
            SearchInstancesEditViewModel.Data(dataWrapper, hasMore, searchCriteria)
        }
    }
}