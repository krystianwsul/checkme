...
class Instance private constructor(
    ...
    fun getCreateTaskTimePair(privateProject: PrivateOwnedProject, myUser: MyUser): TimePair {
    ...
    fun getProjectId(): String = task.projectId
    fun getProject(): Project<*> = task.project
