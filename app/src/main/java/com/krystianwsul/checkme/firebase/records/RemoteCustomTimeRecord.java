...
public class RemoteCustomTimeRecord extends RemoteRecord {
    ...
    RemoteCustomTimeRecord(@NonNull String id, @NonNull RemoteProjectRecord remoteProjectRecord, @NonNull CustomTimeJson customTimeJson) {
        super(false);
    ...
    RemoteCustomTimeRecord(@NonNull RemoteProjectRecord remoteProjectRecord, @NonNull CustomTimeJson customTimeJson) {
        super(true);
