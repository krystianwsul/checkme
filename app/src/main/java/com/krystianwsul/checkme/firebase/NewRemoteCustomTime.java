...
public class NewRemoteCustomTime implements CustomTime {
    @NonNull
    ...
    @NonNull
    private final NewRemoteCustomTimeRecord mRemoteCustomTimeRecord;

    NewRemoteCustomTime(@NonNull DomainFactory domainFactory, @NonNull RemoteProject remoteProject, @NonNull NewRemoteCustomTimeRecord remoteCustomTimeRecord) {
    ...
    public void updateRecordOf(@NonNull Set<String> addedFriends, @NonNull Set<String> removedFriends) {
        // todo customtime copy to new project
    }
}
