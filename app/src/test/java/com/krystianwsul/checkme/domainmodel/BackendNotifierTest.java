...
public class BackendNotifierTest {
    ...
    public void testOneProjectDevelopment() {
        ...
        String url = BackendNotifier.INSTANCE.getUrl(projects, false, new ArrayList<>(), "asdf");
    ...
    public void testOneProjectProduction() {
        ...
        String url = BackendNotifier.INSTANCE.getUrl(projects, true, new ArrayList<>(), "asdf");
    ...
    public void testTwoProjectsTwoUsersProduction() {
        ...
        String url = BackendNotifier.INSTANCE.getUrl(projects, true, userKeys, "asdf");
