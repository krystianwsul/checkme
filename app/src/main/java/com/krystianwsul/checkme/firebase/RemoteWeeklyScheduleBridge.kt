...
class RemoteWeeklyScheduleBridge(private val kotlinDomainFactory: KotlinDomainFactory, private val mRemoteWeeklyScheduleRecord: RemoteWeeklyScheduleRecord) : WeeklyScheduleBridge {

    override val daysOfWeek get() = setOf(mRemoteWeeklyScheduleRecord.dayOfWeek)

    override val customTimeKey get() = mRemoteWeeklyScheduleRecord.run { customTimeId?.let { kotlinDomainFactory.getCustomTimeKey(projectId, it) } }
