...
public class DailyScheduleLoader extends DomainLoader<DailyScheduleLoader.Data, DailyScheduleLoader.Observer> {
    ...
    @Override
    protected DailyScheduleLoader.Observer newObserver() {
        return new Observer();
    }
